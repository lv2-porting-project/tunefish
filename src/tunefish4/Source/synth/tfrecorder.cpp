...
eBool eTfRecorder::saveToFile(File &fileBin)
{
    ...
    OutputStream *outBin = fileBin.createOutputStream();
    OutputStream *outLog = fileLog.createOutputStream();
    OutputStream *outJSON = fileJSON.createOutputStream();
    ...
    */
    ...
    InputStream *inHeader = headerIn.createInputStream();
    ...
    OutputStream *outHeader = headerOut.createOutputStream();
